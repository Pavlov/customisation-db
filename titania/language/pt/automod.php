...
$lang = array_merge($lang, array(
	...
	'NO_INSTALLED_MODS'						=> 'Detetadas Modificações não instaladas',
	'NO_MOD'								=> 'A Modificação selecionada não foi encontrada.',
	'NO_UNINSTALLED_MODS'					=> 'Não foram detetadas Modificações não instaladas',
	...
	'PRE_INSTALL'							=> 'A preparar instalação',
	...
	'PRE_UNINSTALL'							=> 'A preparar desinstalação',
	...
	'REMOVING_FILES'						=> 'Ficheiros a excluir',
	'RETRY'									=> 'Inverter',
	'RETURN_MODS'							=> 'Regressar ao AutoMOD',
	'REVERSE'								=> 'Reverse',
	...
	'STATUS'								=> 'Estatuto',
	'STORE_IS_WRITABLE'						=> 'A diretoria store/ é gravável.',
	'STORE_NOT_WRITABLE'					=> 'A diretoria store/ não é gravável.',
	'STORE_NOT_WRITABLE_INST'				=> 'A instalação do AutoMOD detetou que a diretoria store/ não é gravável. Isto é necessário para que o AutoMOD funcione adequadamente. Por favor ajuste as configurações.',
	...
	'UNINSTALLED_EXPLAIN'					=> 'A Modificação foi desinstalada! Aqui pode ver alguns dos resultados da desinstalação. Observe os erros e procure apoio em <a href="http://www.phpbb.com">phpBB.com</a> ou <a href="http://www.phpbbportugal.com">phpBB Portugal.com</a>.',
	'UNINSTALLED_MODS'						=> 'Modificações desinstaladas',
	'UNINSTALL_AUTOMOD'						=> 'Desinstalação do AutoMOD',
	'UNINSTALL_AUTOMOD_CONFIRM'				=> 'Tem a certeza que deseja desinstalar o AutoMOD?  Não serão remividas Modificações instaladas com o AutoMOD.',
	'UNKNOWN_MOD_AUTHOR-NOTES'				=> 'Não há notas do autor.',
	'UNKNOWN_MOD_COMMENT'					=> '',
	...
	'UPDATE_AUTOMOD_CONFIRM'				=> 'Por favor confirme que deseja atualizar o AutoMOD.',
	'UPLOAD'								=> 'Enviar',
	...
	'WRITE_METHOD_EXPLAIN'					=> 'Pode definir o método preferido para gravar ficheiros. A opção mais compatível é "Transferir ficheiro comprimido".',
	'WRITE_METHOD_FTP'						=> 'FTP',
	'WRITE_METHOD_MANUAL'					=> 'Transferir ficheiro comprimido',
	...
	'in-line-after-add'						=> 'Na linha, adicionar depois',
	'in-line-before-add'					=> 'Na linha, adicionar antes',
	'in-line-edit'							=> 'No linha procurar',
	'in-line-operation'						=> 'In-Line Increment',
	'in-line-replace'						=> 'Na linha substituir',
	'in-line-replace-with'					=> 'Na linha substituir',
